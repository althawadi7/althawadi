    ...
    if kind in ("image", "gallery"):
        ...
        if len(imgs) == 1:
            ...
            return (
                ...
                f'<figure class="ref-detail-media ref-detail-media--image{fig_extra}" data-ref-zoom>'
                ...
                f'<img src="{src}" alt="{alt}" loading="lazy" data-fullsrc="{src}" />'
